		...
		<div className="match">
			<div className="match-header">
				<div className="match-date">
					<span className="date-time">{dataGame?.begin_at.slice(-9, -4)}</span>
					<span className="date-day">{dataGame?.begin_at.slice(5, 10)}</span>
				</div>
				<div className="match-game">
					{dataGame.videogame.name}
				...
				<div className="teamLeft team">
					...
					<div className="team-logo">
						<img
							width={24}
							height={24}
							src={dataGame.opponents[0]?.opponent.image_url || "TBD"}
							alt="logo"
						/>
					</div>
